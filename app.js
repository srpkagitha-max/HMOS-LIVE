...
} from "./firebase-service.js?v=4.5.27";

const app = document.querySelector("#app");
const HMOS_VERSION = "4.5.27";
...
function sharingFeeForRoom(room){
  ...
  return map[n]||Number(b.defaultTotalFees||state.instituteSession?.defaultTotalFees||0);
}
